...
var NotiflixNotify = function(message, callback, theType, staticType) {
	...
	if (arguments != undefined && arguments.length === 4) {
		...
		if (newNotifySettings.backOverlay) {
			...
			notifyOverlay.style.animationDuration = (newNotifySettings.cssAnimation) ? newNotifySettings.cssAnimationDuration +
				'ms' : '';
		...
		ntflxNotify.className = newNotifySettings.className + ' ' + theType.childClassName + ' ' + (newNotifySettings.cssAnimation ?
				'with-animation' : '') + ' ' + (newNotifySettings.useIcon ? 'with-icon' : '') + ' nx-' + newNotifySettings.cssAnimationStyle +
			' ' + (newNotifySettings.closeButton && !callback ? 'with-close' : '') + ' ' + (callback && typeof callback ===
		...
		if (newNotifySettings.useIcon) {
			...
			if (newNotifySettings.useFontAwesome) { // use font awesome
				...
				ntflxNotify.innerHTML = '<i style="color:' + theType.fontAwesomeIconColor + '; font-size:' + newNotifySettings.fontAwesomeIconSize +
					';" class="nmi wfa ' + theType.fontAwesomeClassName + ' ' + (newNotifySettings.fontAwesomeIconStyle === 'shadow' ?
						'shadow' : 'basic') + '"></i><span class="the-message with-icon">' + message + '</span>' + (newNotifySettings.closeButton ?
						closeButtonHTML : '');
				...
				ntflxNotify.innerHTML = svgIcon + '<span class="the-message with-icon">' + message + '</span>' + (
			...
			ntflxNotify.innerHTML = '<span class="the-message">' + message + '</span>' + (newNotifySettings.closeButton ?
				closeButtonHTML : '');
		}
		// use icon off
		// notify content off
		...
		if (newNotifySettings.showOnlyTheLastOne && notiflixNotifyCount > 0) {
			...
			var allNotifyElmNotTheLastOne = document.querySelectorAll('[id^=' + newNotifySettings.ID + '-]:not([id=' +
				newNotifySettings.ID + '-' + notiflixNotifyCount + '])');
...
var NotiflixReport = function(title, message, buttonText, buttonCallback, theType, staticType) {
	...
	if (newReportSettings.backOverlay) {
		reportOverlay = '<div class="' + newReportSettings.className + '-overlay' + (newReportSettings.cssAnimation ?
	...
	ntflxReportWrap.innerHTML = reportOverlay + '<div class="' + newReportSettings.className + '-content' + (
			newReportSettings.cssAnimation ? ' with-animation ' : '') + ' nx-' + newReportSettings.cssAnimationStyle +
		'" style="background:' + newReportSettings.backgroundColor + '; animation-duration:' + newReportSettings.cssAnimationDuration +
		'ms;">' +
		'<div style="width:' + newReportSettings.svgSize + '; height:' + newReportSettings.svgSize + ';" class="' +
		newReportSettings.className + '-icon">' + svgIcon + '</div>' +
		'<h5 class="' + newReportSettings.className + '-title" style="font-weight:500; font-size:' + newReportSettings.titleFontSize +
		'; color:' + theType.titleColor + ';">' + title + '</h5>' +
		'<p class="' + newReportSettings.className + '-message" style="font-size:' + newReportSettings.messageFontSize +
		'; color:' + theType.messageColor + ';">' + message + '</p>' +
		'<a id="NXReportButton" class="' + newReportSettings.className + '-button" style="font-weight:500; font-size:' +
		newReportSettings.buttonFontSize + '; background:' + theType.buttonBackground + '; color:' + theType.buttonColor +
		';">' + buttonText + '</a>' +
		'</div>';
...
var NotiflixConfirm = function(title, message, okButtonText, cancelButtonText, okButtonCallback, cancelButtonCallback) {
	...
	ntflxConfirmWrap.className = newConfirmSettings.className + (newConfirmSettings.cssAnimation ? ' with-animation nx-' +
		newConfirmSettings.cssAnimationStyle : '');
	...
	if (newConfirmSettings.backOverlay) {
		confirmOverlay = '<div class="' + newConfirmSettings.className + '-overlay' + (newConfirmSettings.cssAnimation ?
				' with-animation' : '') + '" style="background:' + newConfirmSettings.backOverlayColor + ';animation-duration:' +
			newConfirmSettings.cssAnimationDuration + 'ms;"></div>';
	}
	// if background overlay true off
	...
	if (okButtonCallback) {
		cancelButtonHTML = '<a id="NXConfirmButtonCancel" class="confirm-button-cancel" style="color:' + newConfirmSettings.cancelButtonColor +
	...
	ntflxConfirmWrap.innerHTML = confirmOverlay +
		'<div class="' + newConfirmSettings.className + '-content" style="background:' + newConfirmSettings.backgroundColor +
		'; animation-duration:' + newConfirmSettings.cssAnimationDuration + 'ms; border-radius: ' + newConfirmSettings.borderRadius +
		';">' +
		'<div class="' + newConfirmSettings.className + '-head">' +
		'<h5 style="color:' + newConfirmSettings.titleColor + ';font-size:' + newConfirmSettings.titleFontSize + ';">' +
		title + '</h5>' +
		'<p style="color:' + newConfirmSettings.messageColor + ';font-size:' + newConfirmSettings.messageFontSize + ';">' +
		message + '</p>' +
		'</div>' +
		'<div class="' + newConfirmSettings.className + '-buttons">' +
		'<a id="NXConfirmButtonOk" class="confirm-button-ok' + (okButtonCallback ? '' : ' full') + '" style="color:' +
		newConfirmSettings.okButtonColor + ';background:' + newConfirmSettings.okButtonBackground + ';font-size:' +
		newConfirmSettings.buttonsFontSize + ';">' + okButtonText + '</a>' +
		cancelButtonHTML +
		'</div>' +
		'</div>';
	// confirm wrap off
...
var NotiflixLoading = function(message, iconType, display, theDelay) {
	...
	if (display) { // show it
		...
		if (message.length > 0) {
			...
			messageHTML = '<p id="' + newLoadingSettings.messageID + '" class="loading-message" style="color:' +
				newLoadingSettings.messageColor + ';font-size:' + newLoadingSettings.messageFontSize + ';height:' + messageHeight +
				'; top:' + messagePosTop + ';">' + message + '</p>';
		}
		...
		if (iconType === 'standard') {
			...
			svgIcon = '<img class="custom-loading-icon" width="' + newLoadingSettings.svgSize + '" height="' +
				newLoadingSettings.svgSize + '" src="' + newLoadingSettings.customSvgUrl + '" alt="Notiflix">';
		} else if (iconType === 'custom' && newLoadingSettings.customSvgUrl == null) {
			notiflixConsoleError('Notiflix Error',
		...
		var svgIconHTML = '<div style="top:' + svgPosTop + '; width:' + newLoadingSettings.svgSize + '; height:' +
			newLoadingSettings.svgSize + ';" class="' + newLoadingSettings.className + '-icon' + (message.length > 0 ?
				' with-message' : '') + '">' + svgIcon + '</div>';
		// svgIcon off
		...
		ntflxLoadingWrap.className = newLoadingSettings.className + (newLoadingSettings.cssAnimation ? ' with-animation' :
...
var notiflixReportSvgSuccess = function(width, color) {
	...
	var reportSvgSuccess = '<svg id="NXReportSuccess" fill="' + color + '" width="' + width + '" height="' + width +
...
var notiflixReportSvgFailure = function(width, color) {
	...
	var reportSvgFailure = '<svg id="NXReportFailure" fill=" ' + color + '" width="' + width + '" height="' + width +
...
var notiflixReportSvgWarning = function(width, color) {
	...
	var reportSvgWarning = '<svg id="NXReportWarning" fill="' + color + '" width="' + width + '" height="' + width +
...
var notiflixReportSvgInfo = function(width, color) {
	...
	var reportSvgInfo = '<svg id="NXReportInfo" fill="' + color + '" width="' + width + '" height="' + width +
...
var notiflixLoadingSvgStandard = function(width, color) {
	...
	var standard = '<svg stroke="' + color + '" width="' + width + '" height="' + width +
...
var notiflixLoadingSvgHourglass = function(width, color) {
	...
	var hourglass = '<svg id="NXLoadingHourglass" fill="' + color + '" width="' + width + '" height="' + width +
...
var notiflixLoadingSvgCircle = function(width, color) {
	...
	var circle = '<svg id="NXLoadingCircle" width="' + width + '" height="' + width +
...
var notiflixLoadingSvgArrows = function(width, color) {
	...
	var arrows = '<svg id="NXLoadingArrows" fill="' + color + '" width="' + width + '" height="' + width +
...
var notiflixLoadingSvgDots = function(width, color) {
	...
	var dots = '<svg id="NXLoadingDots" fill="' + color + '" width="' + width + '" height="' + width +
...
var notiflixLoadingSvgPulse = function(width, color) {
	...
	var pulse = '<svg stroke="' + color + '" width="' + width + '" height="' + width +
...
var notiflixLoadingSvgNotiflix = function(width, white, green) {
	...
	var notiflixIcon = '<svg id="NXLoadingNotiflixLib" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="' +
		width + '" height="' + width +
